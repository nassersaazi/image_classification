<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="CICS.official.Login" %>
                ...
                <div > 
                  <ul >
                    ...
                    <li class="list-inline-item" >
                      <a class="nav-link" id="navlinks" href="#">Register</a>
                    </li>
			...
			<div class="col-md-5">
                ...
                <div class="row">
					...
					<div class="col-md-12 login">
						<a href="#"><div class="btn btn-info btn-block">LOGIN</div></a>
					</div>
				</div>
